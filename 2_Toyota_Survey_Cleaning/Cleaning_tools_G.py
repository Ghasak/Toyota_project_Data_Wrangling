...
def prettyDescribeTable(df):
    ...
    print("{:30.25}{:10.10}{:10.10}{:10.10}{:10.10}{:10.10}{:10.10}{:10.10}".format(df.columns[0],df.columns[1],df.columns[2],df.columns[3],df.columns[4],df.columns[5],df.columns[6],df.columns[7]))
