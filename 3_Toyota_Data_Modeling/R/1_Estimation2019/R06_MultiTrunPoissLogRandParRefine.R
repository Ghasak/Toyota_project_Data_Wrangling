...
directory_location <- "~/Desktop/ToyotaProject/Toyota_project_Data_Wrangling/3_Toyota_Data_Modeling/R/0_DataSet/DataSet.csv"
    ...
    Sumx <<- matrix(0,NROW(ux),1)
      for (r in 1:NROW(ux)){
          lmx1[r] = exp(   beta1
                         ...
                         + (beta16+sigma15*ux[r,4]) * NonDividedSigleRoadway[q]
          ...
          lmx2[r] = exp(    beta21
                         ...
                         + (beta35+sigma33*ux[r,5]) * IsThereSkewness[q]
          ...
          lmx3[r] = exp(   beta41
                         ...
                         + (beta53)* LogNoLanes[q]
                         + (beta54+sigma51*ux[r,6])* NoLanesChanged[q]
                         ...
                         + (beta59+sigma56*ux[r,7])* SignalizedHighLevelSignal[q]
