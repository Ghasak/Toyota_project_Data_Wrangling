...
for (q in 1:NROW(Data1)) {
    Sumx <<- matrix(0,NROW(ux),1)
      for (r in 1:NROW(ux)){
          lmx1[r] = exp(      beta1
                         + beta2 * Prefectural_Dummy_new[q]
                         + beta3 * Minor_prefectural_road[q]
                         + beta4 * Othertypes[q]
                         + beta5 * conf2_Between_Less3.5_and_5.5m[q]
                         + beta6 * conf2_5.5_m_or_more[q]
                         + beta7 * conf2_9.0_m_or_more[q]
                         + beta8 * conf1_30kmh_orless[q]
                         + beta9 * conf1_40kmh_orless[q]
                         + beta10* conf1_50kmh_orless[q]
                         + beta11* conf1_No_regulation[q]
                         + beta12* log_traffic_volume_2[q]
                         + beta13* traffic_volume_dummy[q]
                         + f1 * ux[r,1])

          lmx2[r] = exp(      beta14
                         + beta15* Prefectural_Dummy_new[q]
                         + beta16* Minor_prefectural_road[q]
                         + beta17* Othertypes[q]
                         + beta18* conf2_Between_Less3.5_and_5.5m[q]
                         + beta19* conf2_5.5_m_or_more[q]
                         + beta20* conf2_9.0_m_or_more[q]
                         + beta21* conf1_30kmh_orless[q]
                         + beta22* conf1_40kmh_orless[q]
                         + beta23* conf1_50kmh_orless[q]
                         + beta24* conf1_No_regulation[q]
                         + beta25* log_traffic_volume_2[q]
                         + beta26* traffic_volume_dummy[q]
                         + f2 * ux[r,1]
                         + f3 * ux[r,2])

          lmx3[r] = exp(      beta27
                         + beta28* Prefectural_Dummy_new[q]
                         + beta29* Minor_prefectural_road[q]
                         + beta30* Othertypes[q]
                         + beta31* conf2_Between_Less3.5_and_5.5m[q]
                         + beta32* conf2_5.5_m_or_more[q]
                         + beta33* conf2_9.0_m_or_more[q]
                         + beta34* conf1_30kmh_orless[q]
                         + beta35* conf1_40kmh_orless[q]
                         + beta36* conf1_50kmh_orless[q]
                         + beta37* conf1_No_regulation[q]
                         + beta38* log_traffic_volume_2[q]
                         + beta39* traffic_volume_dummy[q]
                         + f4 * ux[r,1]
                         + f5 * ux[r,2]
                         + f6 * ux[r,3])
      ...
      P1[r] = exp(lgamma(y1[q]+e1)-lfactorial(y1[q])-lgamma(e1)+y1[q]*log(lmx1[r])+e1*log(e1)-(y1[q]+e1)*log(lmx1[r]+e1))
      P2[r] = exp(lgamma(y2[q]+e2)-lfactorial(y2[q])-lgamma(e2)+y2[q]*log(lmx2[r])+e2*log(e2)-(y2[q]+e2)*log(lmx2[r]+e2))
      P3[r] = exp((y3[q])*(log(lmx3[r]))-(lmx3[r])-lfactorial(y3[q]))

      # ========== Probability of Zero ======
      SPrz1[r] = (e1^e1)/((lmx1[r]+e1)^e1)
      SPrz2[r] = (e2^e2)/((lmx2[r]+e2)^e2)
      SPrz3[r] = exp(-lmx3[r])
      # ========== Probability of Zero
